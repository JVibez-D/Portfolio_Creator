...
# Anpassung der X-Achse: Vergrößerter Platz und Rotation der Beschriftungen
plt.xticks(rotation=45, ha='right')  # Rotiert die Beschriftungen leicht und richtet sie nach rechts aus
plt.tight_layout()  # Stellt sicher, dass alles ins Bild passt

sector_chart_path = os.path.join(output_folder, "allocation_by_sectors.png")
plt.savefig(sector_chart_path, dpi=200)  # Höhere Auflösung
plt.close()
